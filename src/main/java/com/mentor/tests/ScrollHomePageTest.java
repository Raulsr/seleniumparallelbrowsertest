...
public class ScrollHomePageTest extends SuperTestNG{
	@Test
	public void test_ScrollHomePageTest() throws InterruptedException
	{
		...
		loginPage.login();
		Thread.sleep(10000);
		homePage.scrollingByCoordinatesofAPage();
	}
}
