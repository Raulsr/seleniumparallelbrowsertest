...
public class ReadingProfilePageTest extends SuperTestNG{
	
	@Test
	
	public void test_ReadingProfilePageTest() throws InterruptedException
	{
		...
		profilePage.getExistingUserDetails();
	}
